...
jQuery(document).ready(function() {
    ...
    */
    $('.top-content').backstretch("resources/assets/img/backgrounds/1.jpg");
    $('.counters-container').backstretch("resources/assets/img/backgrounds/2.jpg");
    $('.our-motto-container').backstretch("resources/assets/img/backgrounds/2.jpg");
