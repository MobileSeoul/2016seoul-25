...
(function () {
    ...
    var u = !!document.createElement("canvas").getContext, qa = {
        ...
        ca = {
            ...
            return function (h, p, k) {
                ...
                k = r ? "getUTC" : "get";
                var s = h[k + "Date"](), y = h[k + "Day"](),
                    t = h[k + "Month"](), z = h[k + "FullYear"](), v = h[k + "Hours"](), u = h[k + "Minutes"](), W = h[k + "Seconds"](), x = h[k + "Milliseconds"](), w = r ? 0 : h.getTimezoneOffset();
            ...
            for (y = r = h = l = p = 0; 0 < k.length;)if (c = k.pop(), "#" === c || "0" === c)if (p++, p === m) {
                var t = g, g = [];
                if ("0" === c)for (c = m - l - (t ? t.length : 0); 0 < c;)t.unshift("0"), c--;
                for (; 0 < t.length;)b = t.pop() + b, y++, 0 === y % r && (h === q && 0 < t.length) && (b = f + b);
                d && (b = "-" + b)
            } else 0 < g.length ? (b = g.pop() + b, l++, y++) : "0" === c && (b = "0" + b, l++, y++), 0 === y % r && (h === q && 0 < g.length) && (b = f + b); else"E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (h++, r = y, y = 0, 0 < g.length && (b = f + b)) : b = 1 < c.length &&
    ...
    w.prototype._updateOptions =
        function () {
            ...
            if ("undefined" === typeof qa.Chart.creditHref)this.creditHref = "", this.creditText = ""; else var b = this.updateOption("creditText"), d = this.updateOption("creditHref");
    ...
    w.prototype._initialize = function () {
        ...
        this.plotInfo =
        {axisPlacement: null, axisXValueType: null, plotTypes: []};
        this.layoutManager = new da(0, 0, this.width, this.height, 2);
        this.plotArea.layoutManager && this.plotArea.layoutManager.reset();
        this.data = [];
        var a = 0;
        if (this._options.data)for (var c = 0; c < this._options.data.length; c++)if (a++, !this._options.data[c].type || 0 <= w._supportedChartTypes.indexOf(this._options.data[c].type)) {
    ...
    w.prototype.categoriseDataSeries = function () {
        for (var a = "", c = 0; c < this.data.length; c++)if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= w._supportedChartTypes.indexOf(a.type)) {
    ...
    w.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = !1, h = !1, p = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n =
                    this.data[a.dataSeriesIndexes[k]], m = 0, l = !1, q = !1, r;
    ...
    w.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f, g, h = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
            ...
            for (n = 0; n < k.dataPoints.length; n++) {
                ...
                if (!(d < y) || m) {
                    ...
                    if (d > t && !l)l = !0; else if (d > t && l)continue;
                    k.dataPoints[n].label && (a.axisX.labels[d] = k.dataPoints[n].label);
                    d < b.viewPortMin && (b.viewPortMin = d);
                    d > b.viewPortMax && (b.viewPortMax = d);
                    if (b.viewPortMin === d && e)for (z = 0; z < e.length; z++)if (null === e[z] && q < d) {
                        b.viewPortMin = q;
                        break
                    }
    ...
    w.prototype._plotAreaMouseMove = function (a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled)e = {
                ...
                var d = e ? this.dragStartPoint.x : this.plotArea.x1, g = f ? this.dragStartPoint.y : this.plotArea.y1, h = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, p = f ? c - this.dragStartPoint.y : this.plotArea.y2 -
                this.plotArea.y1;
    ...
    w.prototype.renderIndexLabels = function (a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, e = 0, f = 0, g = b = f = d = e = 0, h = 0, p = 0; p < this._indexLabels.length; p++) {
            ...
            var f = R("indexLabelBackgroundColor", k.dataPoint, k.dataSeries), d = R("indexLabelMaxWidth", k.dataPoint, k.dataSeries), e = R("indexLabelWrap", k.dataPoint, k.dataSeries), r = R("indexLabelLineDashType", k.dataPoint, k.dataSeries), s = R("indexLabelLineColor", k.dataPoint, k.dataSeries),
                y = x(k.dataPoint.indexLabelLineThickness) ? x(k.dataSeries._options.indexLabelLineThickness) ? 0 : k.dataSeries._options.indexLabelLineThickness : k.dataPoint.indexLabelLineThickness, b = 0 < y ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, t = {
                    percent: null,
                    total: null
                }, z = null;
            ...
            if (null !== v && "" !== v) {
                var t = R("indexLabelPlacement", k.dataPoint, k.dataSeries), z = R("indexLabelOrientation", k.dataPoint, k.dataSeries), u = k.direction, W = k.dataSeries.axisX, A = k.dataSeries.axisY, w = !1, q = new O(a, {
                    x: 0,
                    y: 0,
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= n.indexOf("line") || 0 <= n.indexOf("area"))t = "auto", f = 4; else if (0 <= n.indexOf("stacked"))"auto" === t && (t = "inside"); else if ("bubble" === n || "scatter" === n)t = "inside";
                    m = k.point.x - g / 2;
    ...
    w.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                c.beginPath();
                if (0 < h.length) {
                    for (var t = !1, r = 0; r < h.length; r++)if (s = h[r].x.getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !t)))if ("number" !== typeof h[r].y)0 < r && !(g.connectNullData || t || q) && (c.stroke(), u && b.stroke()), t = !0; else {
    ...
    w.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >=
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                c.beginPath();
                if (0 < h.length) {
                    for (var t = !1, r = 0; r < h.length; r++)if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !t)))if ("number" !== typeof h[r].y)0 < r && !(g.connectNullData || t || q) && (c.stroke(), u && b.stroke()), t = !0; else {
                        var z = y;
                        s = a.axisX.convertValueToPixel(s);
                        y = a.axisY.convertValueToPixel(h[r].y);
            ...
            u && b.beginPath();
            return {
                source: c, dest: this.plotArea.ctx, animationCallback: B.xClipAnimation,
    ...
    w.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var r = 0, s, y, t = [];
                b.beginPath();
                if (0 < p.length)for (y = !1, r = 0; r < p.length; r++)if (s = p[r].getTime ? p[r].x.getTime() : p[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !y)))if ("number" !== typeof p[r].y)0 < r && !y && (h.connectNullData ? b.setLineDash && (0 < t.length && (h._options.nullDataLineDashType || !p[r - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = n, k = h.nullDataLineDashType) : (c(t), t = [])), y = !0; else {
                    s = a.axisX.convertValueToPixel(s);
    ...
    w.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < l.length)for (var q = 5 < n && m.bevelEnabled ? !0 : !1, e = 0; e < l.length; e++)if (l[e].getTime ? h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                    f =
                    ...
                    this._eventManager.objectMap[b] = {
                        ...
                        dataSeriesIndex: k, dataPointIndex: e, x1: f, y1: g, x2: r, y2: s
                    };
                    b = C(b);
    ...
    w.prototype.renderStackedColumn = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, h, p = a.axisY.convertValueToPixel(0), g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ?
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var m = a.dataSeriesIndexes[k], l = this.data[m], q = l.dataPoints;
                if (0 < q.length) {
                    var r = 5 < n && l.bevelEnabled ? !0 : !1;
                    c.strokeStyle = "#4572A7 ";
                    for (g = 0; g < q.length; g++)if (b = q[g].x.getTime ? q[g].x.getTime() :
                        ...
                        var s = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0, y = s + n << 0, t;
                        if (0 <= q[g].y) {
                            var z = e[b] ? e[b] : 0;
                            h -= z;
                            t = p - z;
                        ...
                        (q[g].indexLabel || l.indexLabel || q[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: q[g],
                            dataSeries: l,
                            point: {x: d, y: 0 <= q[g].y ? h : t},
                            direction: 0 > q[g].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: s, y1: Math.min(h, t), x2: y, y2: Math.max(h, t)},
                            color: b
                        })
                    }
                }
    ...
    w.prototype.renderStackedColumn100 = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, h, p = a.axisY.convertValueToPixel(0), g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth :
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var m = a.dataSeriesIndexes[k], l = this.data[m], q = l.dataPoints;
                if (0 < q.length)for (var r = 5 < n && l.bevelEnabled ? !0 : !1, g = 0; g < q.length; g++)if (b = q[g].x.getTime ? q[g].x.getTime() :
                        q[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                    d = a.axisX.convertValueToPixel(b);
    ...
    w.prototype.renderBar = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = 0, f, g, h, p = a.axisY.convertValueToPixel(0), e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ?
                this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < l.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (e = 0; e < l.length; e++)if (l[e].getTime ? h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
    ...
    w.prototype.renderStackedBar = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, h, p = a.axisY.convertValueToPixel(0),
                g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var m = a.dataSeriesIndexes[k], l = this.data[m],
                    q = l.dataPoints;
                if (0 < q.length) {
                    var r = 5 < n && l.bevelEnabled ? !0 : !1;
                    c.strokeStyle = "#4572A7 ";
                    for (g = 0; g < q.length; g++)if (b = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                        d = a.axisX.convertValueToPixel(b);
                        h = a.axisY.convertValueToPixel(q[g].y);
                        var s = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0, y = s + n << 0, t;
                        if (0 <= q[g].y) {
                        ...
                        (q[g].indexLabel || l.indexLabel || q[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: q[g],
                            dataSeries: l,
                            point: {x: 0 <= q[g].y ? h : t, y: d},
                            direction: 0 > q[g].y === a.axisY.reversed ?
                                1 : -1,
                            bounds: {x1: Math.min(t, h), y1: s, x2: Math.max(t, h), y2: y},
                            color: b
                        })
                    }
                }
    ...
    w.prototype.renderStackedBar100 = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, h, p = a.axisY.convertValueToPixel(0), g = this.dataPointMinWidth ?
                this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            n = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(n) / a.plotType.plotUnits.length) << 0;
    ...
    w.prototype.renderArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                g = C(g);
                d.fillStyle = g;
                var g = [], m = !0, l = 0, q, r, s, y = a.axisY.convertValueToPixel(0), t, z = null;
                if (0 < n.length) {
                    var v = k._colorSet[l % k._colorSet.length], x = k._options.lineColor || v, w = x;
                    b.fillStyle = v;
                    b.strokeStyle = x;
                    b.lineWidth = k.lineThickness;
                    var A = "solid";
                    if (b.setLineDash) {
                        var H = D(k.nullDataLineDashType, k.lineThickness), A = k.lineDashType, K = D(A, k.lineThickness);
                        b.setLineDash(K)
                    }
                    for (var I = !0; l < n.length; l++)if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !I)))if ("number" !== typeof n[l].y)k.connectNullData || (I || m) || c(), I = !0; else {
    ...
    w.prototype.renderSplineArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                g = C(g);
                d.fillStyle = g;
                var g = [], m = 0, l, q, r = a.axisY.convertValueToPixel(0), s, y = null, t = [];
                if (0 < n.length) {
                    var z = k._colorSet[m % k._colorSet.length], v = k._options.lineColor || z, x = v;
                    b.fillStyle = z;
                    b.strokeStyle = v;
                    b.lineWidth = k.lineThickness;
                    var w = "solid";
                    if (b.setLineDash) {
                        var A = D(k.nullDataLineDashType, k.lineThickness), w = k.lineDashType, H = D(w, k.lineThickness);
                        b.setLineDash(H)
                    }
                    for (q = !1; m < n.length; m++)if (l = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax &&
                        (!k.connectNullData || !q)))if ("number" !== typeof n[m].y)0 < m && !q && (k.connectNullData ? b.setLineDash && (0 < t.length && (k._options.nullDataLineDashType || !n[m - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = A, w = k.nullDataLineDashType) : (c(), t = [])), q = !0; else {
    ...
    w.prototype.renderStepArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                g = C(g);
                d.fillStyle = g;
                var g = [], m = !0, l = 0, q, r, s, y = a.axisY.convertValueToPixel(0), t, z = null, v = !1;
                if (0 < n.length) {
                    var x = k._colorSet[l % k._colorSet.length], w = k._options.lineColor || x, A =
                        w;
                    b.fillStyle = x;
                    b.strokeStyle = w;
                    b.lineWidth = k.lineThickness;
                    ...
                    for (; l < n.length; l++)if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !v))) {
                        var G = r;
    ...
    w.prototype.renderStackedArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, e = [], f = this.plotArea, g = [], h = [], p = [], k = 0, n, m, l, q = a.axisY.convertValueToPixel(0), r = this._eventManager.ghostCtx;
            u && r.beginPath();
            b.save();
            u && r.save();
            b.beginPath();
            ...
            for (var s = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                var y = a.dataSeriesIndexes[f], t = this.data[y], z = t.dataPoints;
                t.dataPointIndexes = [];
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                r.fillStyle = k;
                if (0 < p.length) {
                    var d = t._colorSet[0], v = t._options.lineColor || d, x = v;
                    b.fillStyle = d;
                    b.strokeStyle = v;
                    b.lineWidth = t.lineThickness;
                    var w = "solid";
                    if (b.setLineDash) {
                        var A = D(t.nullDataLineDashType, t.lineThickness), w = t.lineDashType, H = D(w, t.lineThickness);
                        b.setLineDash(H)
                    }
                    for (var K = !0, k = 0; k < p.length; k++) {
                        l = p[k];
                        var I = null, I = 0 <= t.dataPointIndexes[l] ? z[t.dataPointIndexes[l]] : {x: l, y: null};
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !K)))if ("number" !== typeof I.y)t.connectNullData || (K || s) || c(), K = !0; else {
                            ...
                            0 == k % 250 && (c(), b.moveTo(n, m), u && r.moveTo(n, m), h.push({x: n, y: q - G})));
                            ...
                            if (0 <= t.dataPointIndexes[l]) {
                                ...
                                this._eventManager.objectMap[S] = {
                                    ...
                                    dataSeriesIndex: y, dataPointIndex: t.dataPointIndexes[l], x1: n, y1: m
                                }
                            }
    ...
    w.prototype.renderStackedArea100 = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, e = this.plotArea, f = [], g = [], h = [], p = [], k = 0, n, m, l, q = a.axisY.convertValueToPixel(0), r = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0, s = a.axisX.dataInfo.minDiff, s = 0.9 * e.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(s) << 0, y = this._eventManager.ghostCtx;
            b.save();
            u && y.save();
            b.beginPath();
            ...
            for (var t = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                var z = a.dataSeriesIndexes[e], v = this.data[z], x = v.dataPoints;
                v.dataPointIndexes = [];
            ...
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                h = [];
                if (0 < p.length) {
                    var d = v._colorSet[k % v._colorSet.length], w = v._options.lineColor || d, A = w;
                    b.fillStyle = d;
                    b.strokeStyle = w;
                    b.lineWidth = v.lineThickness;
                    var H = "solid";
                    if (b.setLineDash) {
                        var K = D(v.nullDataLineDashType, v.lineThickness), H = v.lineDashType, I = D(H, v.lineThickness);
                        b.setLineDash(I)
                    }
                    for (var G = !0, k = 0; k < p.length; k++) {
                        l = p[k];
                        var S = null, S = 0 <= v.dataPointIndexes[l] ? x[v.dataPointIndexes[l]] : {x: l, y: null};
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax &&
                            (!v.connectNullData || !G)))if ("number" !== typeof S.y)v.connectNullData || (G || t) || c(), G = !0; else {
    ...
    w.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= b)) {
            var d = this.plotArea, e = 0, f, g;
            a.axisY.convertValueToPixel(0);
            var h = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0, e = a.axisX.dataInfo.minDiff, b = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(e) / b) << 0;
            c.save();
            u && this._eventManager.ghostCtx.save();
            c.beginPath();
            c.rect(d.x1, d.y1, d.width, d.height);
            c.clip();
            u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (var p = -Infinity, k = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++)for (var m =
            ...
            for (var s = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, s), n = 0; n < a.dataSeriesIndexes.length; n++)if (m = a.dataSeriesIndexes[n], l = this.data[m], q = l.dataPoints, 1 == q.length && (b = h), 1 > b ? b = 1 : b > h && (b = h), 0 < q.length)for (c.strokeStyle = "#4572A7 ",
                                                                                                                                                                                                                                                                                                                        e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                f = a.axisX.convertValueToPixel(f);
                g = a.axisY.convertValueToPixel(q[e].y);
                var r = q[e].z, y = 2 * Math.max(Math.sqrt((p === k ? d / 2 : s + (d - s) / (p - k) * (r - k)) / Math.PI) << 0, 1), r = l.getMarkerProperties(e, c);
                r.size = y;
                ...
                {id: t, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: e, x1: f, y1: g, size: y};
                y = C(t);
        ...
        if (!(0 >= b)) {
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < m.length) {
                    ...
                    for (var l = 0, q = 0, e = 0; e < m.length; e++)if (f = m[e].getTime ? f = m[e].x.getTime() : f =
    ...
    w.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, d = this.plotArea, e = 0, f, g, h, p, k, n;
            a.axisY.convertValueToPixel(0);
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < s.length)for (var y = 5 < m && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)if (s[e].getTime ? n = s[e].x.getTime() : n = s[e].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] &&
                    ...
                    var t = f - m / 2 << 0, z = t + m << 0, d = s[e].color ? s[e].color : r._colorSet[0], v = Math.round(Math.max(1, 0.15 * m)), x = 0 === v % 2 ? 0 : 0.5, w = r.dataPointIds[e];
                    ...
                    (s[e].indexLabel || r.indexLabel || s[e].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        dataPoint: s[e],
                        dataSeries: r,
                        point: {x: t + (z - t) / 2, y: a.axisY.reversed ? p : h},
                        direction: 1,
                        bounds: {x1: t, y1: Math.min(h, p), x2: z, y2: Math.max(h, p)},
                        color: d
                    })
                }
            }
    ...
    w.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                var k = a.dataSeriesIndexes[p], n = this.data[k], m = n.dataPoints;
                if (0 < m.length)for (var l = 5 < h && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)if (m[e].getTime ? g = m[e].x.getTime() : g = m[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                    ...
                    h / 2 + (a.previousDataSeriesCount + p) * h << 0, r = a.axisX.reversed ? q - h << 0 : q + h << 0, b = m[e].color ? m[e].color : n._colorSet[e % n._colorSet.length];
                    if (d > f) {
                        var s = d, d = f;
                        f = s
                    }
    ...
    w.prototype.renderRangeBar = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = 0, f, g, h;
            a.axisY.convertValueToPixel(0);
            e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (e = 0; e < l.length; e++)if (l[e].getTime ? h = l[e].x.getTime() :
    ...
    w.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                e = C(e);
                d.fillStyle = e;
                var e = [], n = !0, m = 0, l, q, r, s;
                a.axisY.convertValueToPixel(0);
                var y = null;
                if (0 < k.length) {
                    var t = p._colorSet[m % p._colorSet.length], z = p._options.lineColor || t, v = z;
                    b.fillStyle = t;
                    b.strokeStyle = z;
                    b.lineWidth = p.lineThickness;
                    var x = "solid";
                    if (b.setLineDash) {
                        var w = D(p.nullDataLineDashType, p.lineThickness), x = p.lineDashType, A = D(x, p.lineThickness);
                        b.setLineDash(A)
                    }
                    for (var H = !0; m < k.length; m++)if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !H)))if (null !== k[m].y && k[m].y.length && "number" === typeof k[m].y[0] &&
    ...
    w.prototype.renderRangeSplineArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var q = [], r = [];
                if (0 < p.length) {
                    var s = h._colorSet[k % h._colorSet.length], y = h._options.lineColor || s, t = y;
                    b.fillStyle = s;
                    b.lineWidth = h.lineThickness;
                    var z = "solid", v;
                    if (b.setLineDash) {
                    ...
                    for (m = !1; k < p.length; k++)if (n = p[k].x.getTime ? p[k].x.getTime() : p[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !m)))if (null !== p[k].y && p[k].y.length && "number" === typeof p[k].y[0] && "number" === typeof p[k].y[1]) {
                        ...
                        if (0 !== p[k].markerSize && (0 < p[k].markerSize || 0 < h.markerSize)) {
                            ...
                            H = C(w);
                            u && e.push({
                                x: n, y: l, ctx: d, type: A.type, size: A.size,
                                color: H, borderColor: H, borderThickness: A.borderThickness
                            })
                        }
    ...
    w.prototype.renderPie = function (a) {
        function c() {
            if (k && n) {
                for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                    var f = n[e], g = k.dataPointIds[e],
                        h = {id: g, objectType: "dataPoint", dataPointIndex: e, dataSeriesIndex: 0};
                    q.push(h);
                    var m = {percent: null, total: null}, r = null, m = p.getPercentAndTotal(k, f);
        ...
        function d(a, b) {
            var c = 0, c = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height /
                2, d = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height / 2, e = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height / 2, f = b.indexLabelTextBlock.y + b.indexLabelTextBlock.height / 2;
        ...
        function e(a) {
            for (var b = null, c = 1; c < n.length; c++)if (b = (a + c + q.length) % q.length, q[b].hemisphere !== q[a].hemisphere) {
                ...
                q[a].indexLabelTextBlock.y)))break; else b = null;
            return b
        }
        ...
        function g() {
            ...
            for (var b = a = 0, c = 0, g = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                ...
                } else for (a = 0; a < n.length; a++)h = q[a], s = "pie" === k.type ? 0.7 * A : 0.8 * A, w = v.x + s * Math.cos(h.midAngle), x = v.y + s * Math.sin(h.midAngle), h.indexLabelTextBlock.x = w, h.indexLabelTextBlock.y = x;
                for (a = 0; a < n.length; a++)if (h = q[a], w = h.indexLabelTextBlock.measureText(),
                ...
                (function () {
                    for (var a = -1, b = -1, c = 0, f = !1, g = 0; g < n.length; g++)if (f = !1, t = q[g], t.indexLabelText) {
                        var h = e(g);
                        if (null !== h) {
                            var k = q[h];
                            B = 0;
                            ...
                            if (l = 0 > B) {
                                ...
                                var p = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2, r = t.indexLabelTextBlock.y + t.indexLabelTextBlock.height / 2, s = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2, y = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width, u = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2;
        ...
        var p = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var k = this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, m = 10, l = this.plotArea, q = [], r = 2, s, y = 1.3, t = 20 / 180 * Math.PI, u = 6, v = {
                x: (l.x2 + l.x1) / 2,
                y: (l.y2 + l.y1) / 2
            }, w = 0;
            a = !1;
    ...
    O.prototype._wrapText = function () {
        ...
        for (this.ctx.font = this._getFontString(); 0 < a.length;) {
            var f = this.maxHeight - 2 * this.padding, g = this._getLineWithWidth(a, this.maxWidth -
                2 * this.padding, !1);
            g.height = this._lineHeight;
            c.push(g);
            var h = e, e = Math.max(e, g.width), d = d + g.height, a = ea(a.slice(g.text.length, a.length));
    ...
    oa.prototype.render = function () {
        var a =
            this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(), b = null, d = 0, e = 0, f = 0, g = 0, h = this.chart._options.legend && !x(this.chart._options.legend.markerMargin) ? this.chart._options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var p = [], k = [];
        ...
        for (var n = 0; n < this.dataSeries.length; n++) {
            ...
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                var l = m.legendMarkerType ? m.legendMarkerType : "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type && "scatter" !== m.type && "bubble" !== m.type || !m.markerType ? Y.getDefaultLegendMarker(m.type) : m.markerType, q = m.legendText ? m.legendText :
                    ...
                    s)) : 0, q = this.chart.replaceKeywordsWithValue(q, m.dataPoints[0], m, n), l = {
                    markerType: l,
                    markerColor: r,
                    text: q,
                    textBlock: null,
                ...
                p.push(l)
            } else for (var u = 0; u < m.dataPoints.length; u++) {
                var v = m.dataPoints[u], l = v.legendMarkerType ? v.legendMarkerType : m.legendMarkerType ? m.legendMarkerType : Y.getDefaultLegendMarker(m.type), q = v.legendText ? v.legendText : m.legendText ? m.legendText :
                        this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart._publicChartReference,
                            legend: this._options,
                            dataSeries: m,
                            dataPoint: v
                        }) : v.name ? v.name : "DataPoint: " + (u + 1), r = v.legendMarkerColor ? v.legendMarkerColor : m.legendMarkerColor ? m.legendMarkerColor : v.color ? v.color : m.color ? m.color : m._colorSet[u % m._colorSet.length], s = 0.75 * this.lineHeight, y = v.legendMarkerBorderColor ? v.legendMarkerBorderColor : m.legendMarkerBorderColor ? m.legendMarkerBorderColor : v.markerBorderColor ? v.markerBorderColor : m.markerBorderColor,
                    t = v.legendMarkerBorderThickness ? v.legendMarkerBorderThickness : m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : v.markerBorderThickness || m.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0, q = this.chart.replaceKeywordsWithValue(q, v, m, u), l = {
                        markerType: l,
                        markerColor: r,
                        text: q,
                        textBlock: null,
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (l) {
                    switch (this.type) {
                        ...
                        case "splineArea":
                        case "scatter":
                            var s = R("markerSize", q, this) || 4, u = b ? 20 : s, r = Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y1 - c, 2));
                            r <= u && d.push({dataPoint: q, dataPointIndex: f, dataSeries: this, distance: r});
                            f = Math.abs(l.x1 -
                                a);
                            f <= p ? p = f : 0 < g ? k++ : n++;
                            r <= s / 2 && (h = !0);
    ...
    F.prototype.createLabels = function () {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, h), e = za(new Date(this.viewportMaximum), h, this.intervalType), b = this.intervalStartPosition; b < e; za(b, h, this.intervalType))a = b.getTime(), a = this.labelFormatter ?
            this.labelFormatter({
                chart: this.chart._publicChartReference,
                axis: this._options,
                value: b,
        ...
        }), this._ticks.push({position: b.getTime()}); else {
            e = this.viewportMaximum;
            if (this.labels) {
                a = Math.ceil(h);
                for (var m = Math.ceil(this.intervalStartPosition), d = !1, b = m; b < this.viewportMaximum; b += a)if (this.labels[b])d = !0; else {
                    d = !1;
                    break
                }
        ...
        e =
            [];
        m = h = 0;
        if (this.labelAutoFit || this._options.labelAutoFit)if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) {
            var q = 0, f = 0.9 * p >> 0, m = 0;
            if (!this.chart.panEnabled && 1 <= this._labels.length) {
                ...
                b = 0;
                for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)if (a = this._labels[b].textBlock, l = a.measureText(), b < this._labels.length -
                    ...
                    this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth, this.sessionVariables.labelMaxHeight = g, this.sessionVariables.labelWrap = this.labelWrap); else {
            ...
            } else for (b = 0; b < this._labels.length; b++)a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = x(this._options.labelMaxWidth) ?
            ...
            this._position)if (f = x(this._options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this._options.labelMaxWidth, g = "undefined" === typeof this._options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
            this.sessionVariables.labelFontSize = this.labelFontSize;
            this.sessionVariables.labelMaxWidth = f;
            this.sessionVariables.labelMaxHeight = g;
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            this._stripLineLabels.push({
                position: f.value,
                textBlock: a, effectiveHeight: null, stripLine: f
            })
        }
    };
    ...
    F.prototype.createLabelsAndCalculateHeight = function () {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            for (b = 0; b < this._labels.length; b++) {
                ...
                var d = c.measureText(), e = 0, e = 0 === this.labelAngle ? d.height : d.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (d.height - c.fontSize / 2) * Math.cos(Math.PI /
    ...
    F.setLayoutAndRender = function (a, c, b, d, e) {
        ...
        var n = c ? c.margin : 0, m = b ? b.margin : 0, l = 0, q = 0, r = 0, s, u, t, w, v, B, C = 0, A = 0, D, E, I;
        D = E = I = !1;
        ...
        if ("normal" === d) {
            ...
            for (; 4 > l++;) {
                ...
                a.lineCoordinates = {
                    x1: g,
                    y1: d, x2: g, y2: h, height: Math.abs(h - d)
                };
                a.boundingRect = {x1: f, y1: d, x2: g, y2: h, width: g - f, height: h - d};
                ...
                if (a || c || b) {
                    if (!x(G))for (l = 0; l < G.length; l++)for (j = l + 1; j < G.length; j++)G[l] == G[j] && (D = !0);
                    if (!x(F))for (l = 0; l < F.length; l++)for (j =
    ...
    F.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            if (g)for (g = !1, d = 0; d < p.length; d++)b = p[d], b.stripLine.showOnTop ?
    ...
    pa.prototype.render = function () {
        ...
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position)e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1,
                h = this.chart.plotArea.y2; else if ("left" === this.parent._position || "right" === this.parent._position)g = h = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2;
            this.ctx.moveTo(e, g);
            this.ctx.lineTo(f, h);
            this.ctx.stroke();
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    g.dataSeries.axisY.viewportMaximum + f && e.push(g)) : (0 <= g.dataSeries.type.indexOf("100") || "stackedColumn" === d.type || "stackedBar" === d.type || g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum) && e.push(g); else e.push(g)
                }
            }
    ...
    V.prototype.getToolTipInnerHTML = function (a) {
        ...
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter))a = {
            ...
            for (var p =
                "", h = 0; h < a.length; h++)if (b = a[h].dataSeries, d = a[h].dataPoint, e = a[h].index, f = "", 0 === h && (g && !this.content) && (p += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}", p += "</br>", p = this.chart.replaceKeywordsWithValue(p, d, b, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== b._options.toolTipContent)) {
    ...
    w.prototype.replaceKeywordsWithValue =
        function (a, c, b, d, e) {
            ...
            if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var g = "#percent", h = "#total", p = this.getPercentAndTotal(b, c), h = isNaN(p.total) ? h : p.total, g = isNaN(p.percent) ? g : p.percent;
                do {
                    p = "";
    ...
    fa.prototype.mouseEventHandler = function (a) {
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            if ((d = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[d])if (d = this.objectMap[d], "dataPoint" === d.objectType) {
                ...
                d.eventContext = {
                    context: e, userContext: e._options, mouseover: "mouseover", mousemove: "mousemove",
    ...
    va.prototype.animate = function (a, c, b, d, e) {
        ...
        for (a = []; 0 < this.animations.length;)if (c = this.animations.shift(), b = (new Date).getTime(), d = 0, c.startTime <= b && (d = e(Math.min(b - c.startTime, c.duration), 0, 1, c.duration), d = Math.min(d, 1), isNaN(d) || !isFinite(d)) &&
